-- ============================================================
-- CORREÇÃO FINAL: Trigger com service_role key CORRETA
-- e bloco EXCEPTION para nunca bloquear agendamentos
-- ============================================================
...
BEGIN
  ...
  BEGIN
    ...
    PERFORM net.http_post(
      ...
      headers := jsonb_build_object(
        ...
        'Authorization', 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImhoenZqc3Jzb3loanplaXV4cGVwIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc2ODE0NjQyNiwiZXhwIjoyMDgzNzIyNDI2fQ.gqOOrlRbKXDqpdwNZnQPaP2zU_-utWZuNjI8X8MaEZw'
      ),
  ...
  EXCEPTION WHEN OTHERS THEN
    ...
    RAISE WARNING '[trigger_confirmacao] Falha ao enviar WhatsApp: %', SQLERRM;
  END;
