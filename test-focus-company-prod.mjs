const token = 'lkrQudtneLTJ7Ojz1ZzViyM9Q5GF2ddz';
...
const payload = {
  ...
  inscricao_estadual_emitente: '0055568670056', // Updated with correct IE from API response!
  logradouro_emitente: 'AVENIDA GETULIO VARGAS',
  numero_emitente: '81',
  bairro_emitente: 'CENTRO',
  municipio_emitente: 'Monte Belo',
  uf_emitente: 'MG',
  cep_emitente: '37115000',
  regime_tributario: '1',
  itens: [{
    numero_item: 1,
...
async function testFocus() {
  console.log('Enviando NFC-e para Focus NFe em PRODUCAO com COMPANY TOKEN...');
